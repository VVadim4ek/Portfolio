  ...
  return (
    <ul className="ml-mobileBound sm:ml-0 gap-8 sm:gap-11 w-[100%] grid grid-cols-timeline sm:grid-cols-wide-timeline auto-cols-[max-content] before:row-mobile-education-marker sm:before:row-education-marker mobile-marker-time-item sm:before:col-marker-time-item before:bg-primBlue-200">
      {educations.map((education, id) => (
        <li
          key={id}
          className="max-w-[28em] w-[100%] group row-time-item col-mobile-time-item row-mobile-time-item sm:odd:col-odd-time-item sm:even:col-even-time-item sm:[&:nth-child(2)]:row-second-time-item sm:odd:justify-self-end flex flex-col flex-nowrap"
        >
          ...
          <p className="italic">
            <DateTimeStamp date={education.startDate} /> –{" "}
            <DateTimeStamp date={education.endDate} />
          </p>
